<script setup>
import { ref } from 'vue'
import PrivacyPolicy from '../pages/PrivacyPolicySection.vue'
            ...
            <div class="grid md:grid-cols-2">
                <div class="flex flex-col md:flex-row md:space-x-12 items-center">
                    <div class="mb-10 md:mb-0">
                        <a href="/" class="logo-text logo-white">butterboard</a>
                    </div>
                    <ul class="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-8 text-xs text-center md:text-left font-theme-heading">
                        ...
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#" @click.prevent="showPrivacy = true">Конфиденциальность</a>
                        </li>
                    </ul>
                </div>
                <div class="md:place-self-end place-self-center mt-10 md:mt-0">
                    <ul class="flex space-x-8 items-center">
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-telegram text-white hover:text-theme-secondary transition duration-200 cursor-pointer" viewBox="0 0 16 16" href="https://t.me/butterboard_platform">
