    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                ...
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Our aim is to make the onboarding experience for your employees smooth like butter</p>
            </div>
            ...
            <div class="mt-16">
                ...
                <template v-for="feature in features" :key="feature.id">
                    <div v-show="isOpen === feature.id" class="grid gap-32 lg:grid-cols-2 items-center">
                        <div class="relative">
                            <img class="z-10 w-full grayscale-image-features" :src="feature.details.imageUrl" />
